  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        {reviewElements}
        <div className={styles.container}><div className={styles.blue}><b>See all {reviews.length} reviews </b></div><img className={styles.blueArrowRight} src='./img/blueArrowRight.png' /><br /></div>
